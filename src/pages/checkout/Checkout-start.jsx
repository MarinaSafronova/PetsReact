...
function CheckoutStart() {
    ...
    const options = [
        { id: "option1", label: "No" },
        { id: "option2", label: "Yes" },
        { id: "option3", label: "No Sure" },
    ];
            ...
            <div className="flex flex-col items-center w-full gap-10 md:pt-10 lg:gap-12   md:bg-[url('assets/checkout/cloud.svg')] py-5 lg:py-8 bg-no-repeat bg-[center_center] ">
                ...
                <div className="flex flex-col items-center justify-center w-full max-w-3xl gap-6 mx-auto text-center lg:gap-10 text-brown">
                    <h3 className="font-sans font-bold text-2xl leading-[35px] md:leading-[45px] md:text-35 ">
                        <p>Any extra paperwork needed</p>
                        <p> besides your ESA leeter?</p>
                    </h3>
                    <p className="text-base font-Cerebri-Medium leading-[25px] md:leading-[32px] md:text-22">
                        Our licensed clinicians can assit you with any
                        additional forms requiered by housing agencies for an
                        additional fee. Your letter will accommodate for up to 2
                        pets, you can add more later!
                    </p>
