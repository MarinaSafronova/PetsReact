...
const ButtonLink = ({ link, color }) => {
    ...
    return (
        <Link to="/">
            <div className={`flex flex-col  text-center ${color} rounded-full small:min-w-[350px] min-w-[365px]  max-w-[365px] w-full`}>
                <div className="flex gap-2 p-1.5  bg-accent rounded-full transition-all hover:shadow-lg pr-4 relative h-[85px]">
                    ...
                    <div className="flex-auto w-full my-auto">
                        <p
                            className="pl-[69px] text-center w-full  h-full font-bold whitespace-nowrap font-sans  text-2xl tracking-[0.5px] text focus:outline-none focus:ring-2 focus:ring-blue-500"
